...
public class Insert extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        /* ABRAM JOHN HORTEZANO CODED */
        String roll = rollTF.getText();
        String name = nameTF.getText();
        String course = courseTF.getText();
        String semester = semTF.getText();
        String email = emailTF.getText();
        String phone = phTF.getText();
        String title = bknameTF.getText();
        String author = bkauthorTF.getText();
        String id = bkidTF.getText();
        String about = abtTF.getText();
        String edition = edTF.getText();
        

        if (name.trim().isEmpty() || roll.trim().isEmpty() || course.trim().isEmpty() || phone.trim().isEmpty() || semester.trim().isEmpty()
                || email.trim().isEmpty()
                || title.trim().isEmpty()
                || author.trim().isEmpty()
                || about.trim().isEmpty()
            ...
            //} else {
                BookRecord record = new BookRecord(id, title, about, edition, author,
                      roll, name, course, semester, email, phone);

                if (con.insertRecord(record) == true){
                    nameTF.setText("");          
                }
            //}
