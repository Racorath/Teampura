...
public class UpdateDelete extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            String qry = "Select * from books where rollTF = " + rollTF.getText() + " ;";
            
            rs = stmt.executeQuery(qry);
            
            if (rs.next()){
               
                String roll = rs.getString("rollTF");
                String sName = rs.getString("nameTF");
                String course = rs.getString("courseTF");
                String sem = rs.getString("semTF");
                String phone = rs.getString("phTF");
                String email = rs.getString("emailTF");
                String bkid = rs.getString("bkidTF");
                String bkname = rs.getString("bknameTF");
    ...
    private void updBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updBtnActionPerformed
        ...
        if (ans == JOptionPane.YES_OPTION){
            ...
            con = DriverManager.getConnection
                    ("jdbc:mysql://localhost:3306/library","root","");
            stmt = con.createStatement();
            String qry = "Update books set nameTF = '" + nameTF.getText() + "', semTF = '" + semTF.getText() + "', phTF = '" + phTF.getText() + 
                          "', courseTF = '" + courseTF.getText() + "', emailTF = '" + emailTF.getText() + "' where rollTF = '" + rollTF.getText() + "' ;";
            String qry2 = "select * from books where rollTF = '" + rollTF.getText() + "' ;";
    ...
    private void cnfBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cnfBTNActionPerformed
        ...
        if(ans == JOptionPane.YES_OPTION){
            ...
            con = DriverManager.getConnection
                    ("jdbc:mysql://localhost:3306/library","root","");
            stmt = con.createStatement();
            String qry = "Delete from books where rollTF = '" + rollTF.getText() + "' and bkidTF = " + bkidTF.getText() + ";";
            String qry2 = "Select * from books where rollTF = '" + rollTF.getText() + "' ;";
