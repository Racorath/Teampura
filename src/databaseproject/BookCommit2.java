...
public class BookCommit2 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String query = "select * from books "
                    + "where bknameTF like '%" + bknm + "%' and bkauthorTF like '%" + authnm + "%';";
            ...
            while(rs.next()) {
                ...
                String abt = rs.getString("abtTF");
                String ed = rs.getString("edTF");
                String bkauthor = rs.getString("bkauthorTF");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
            BookCommit2 book = new BookCommit2();
